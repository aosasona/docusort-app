...
import {KeyboardAvoidingView, Heading, VStack, Text, Select, CheckIcon} from "native-base"
...
const UploadModal = ({visible, toggleVisibility}) => {
  ...
  return (
	<KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} h={{base: "400px"}} style={{flex: 1}}>
